...
#'
#' @param what ICA or PCA result list created by either \code{gene_expr_ica()} or \code{gene_expr_pca()}.
#' @param how Specifying whether the object is a "ica" object or "pca" object. Default is set to "ica".
...
tellme_aboutit <- function(what = NULL, how = "ica", n.comps = NULL, prefix = NULL, output.path = NULL, file.ext = "png"){

    if(!exists("what")){
      cat("What do you want me to tell you about? \n")
      break;
    }
